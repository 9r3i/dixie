...
<div class="content-form">
  <form action="<?php printf(WWW.'admin/a?data=upload-plugin'); ?>" method="post" class="form-content" enctype="multipart/form-data">
    <div>Upload Plugin <span style="font-size:13px;color:#379;" title="Requires ZIP file">(*.zip)</span><input type="file" name="file" class="form-input" title="click to choose the file" /></div>
